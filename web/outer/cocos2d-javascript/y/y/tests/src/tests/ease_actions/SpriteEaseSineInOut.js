...
var TestCase      = require('./ActionTestCase')
  ...
  , EaseSineInOut = actions.EaseSineInOut
 ...
 * @class
 */
function SpriteEaseSineInOutTest () {
    SpriteEaseSineInOutTest.superclass.constructor.call(this)
}

SpriteEaseSineInOutTest.inherit(TestCase, /** @lends SpriteEaseSineInOutTest# */ {
    title: 'EaseSineInOut action'

  , onEnter: function () {
        SpriteEaseSineInOutTest.superclass.onEnter.call(this)
        ...
        var move = new MoveBy({ duration: 3, position: new Point(s.width-130, 0) })
          ...
          , move_ease = new EaseSineInOut({ action: move.copy() })
...
module.exports = SpriteEaseSineInOutTest
