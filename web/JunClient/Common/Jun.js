(function() {
	...
	Jun.isPlainObject = isPlainObject;
	...
	Jun.getPointOnCanvas = getPointOnCanvas;
	...
	Jun.randomColor = randomColor;

	function randomAngle() {
		return eRandom( - Math.PI, Math.PI);
	}

	Jun.randomAngle = randomAngle;
})();
